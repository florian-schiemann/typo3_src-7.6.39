...
class ImageMagickFile
{
     ...
     */
    public static function fromFilePath($filePath, $frame = null)
    {
     ...
     * @throws Exception
     */
    public function __construct($filePath, $frame = null)
    {
        $this->frame = $frame;
    ...
    protected function resolvePrefix()
    {
        ...
        throw new Exception(
            sprintf(
                ...
                $this->mimeType === null ? 'unknown' : $this->mimeType
            ),
            1550060977
        );
    }
     ...
     * @return bool
     */
    protected function isInAllowedExtensions($extension)
    {
    ...
    {
        return GeneralUtility::makeInstance('TYPO3\CMS\Core\Type\File\FileInfo', $filePath);
    }
}
